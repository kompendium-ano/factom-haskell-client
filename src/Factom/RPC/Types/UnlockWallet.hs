...
instance ToJSON TopLevel where
  toJSON     (TopLevel {..}) = object ["success" .= topLevelSuccess, "unlockeduntil" .= topLevelUnlockeduntil]
  toEncoding (TopLevel {..}) = pairs  ("success" .= topLevelSuccess<>"unlockeduntil" .= topLevelUnlockeduntil)
