...
instance FromJSON TransactionsElt where
  parseJSON (Object v) =
    TransactionsElt <$> v .: "inputs" <*> v .: "outecs" <*>
    v .: "millitimestamp" <*>
    v .: "outputs" <*>
    v .: "sigblocks" <*>
    v .: "blockheight" <*>
...
instance ToJSON TransactionsElt where
  ...
  toEncoding (TransactionsElt {..}) =
    pairs
      ("inputs" .= transactionsEltInputs <> "outecs" .= transactionsEltOutecs <>
       "millitimestamp" .=
...
instance FromJSON Fblock where
  parseJSON (Object v) =
    Fblock <$> v .: "bodymr" <*> v .: "transactions" <*> v .: "chainid" <*>
    v .: "dbheight" <*>
    v .: "prevledgerkeymr" <*>
    v .: "exchrate" <*>
    v .: "ledgerkeymr" <*>
...
instance ToJSON Fblock where
  ...
  toEncoding (Fblock {..}) =
    pairs
      ("bodymr" .= fblockBodymr <> "transactions" .= fblockTransactions <>
       "chainid" .=
       fblockChainid <>
       "dbheight" .=
       fblockDbheight <>
