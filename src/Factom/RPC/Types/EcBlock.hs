...
instance FromJSON EntriesElt where
  parseJSON (Object v) =
    EntriesElt <$> v .:?? "entryhash" <*> v .:?? "credits" <*> v .:?? "version" <*>
    v .:?? "sig" <*>
    v .:?? "serverindexnumber" <*>
    v .:?? "millitime" <*>
    v .:?? "number" <*>
...
instance ToJSON EntriesElt where
  ...
  toEncoding (EntriesElt {..}) =
    pairs
      ("entryhash" .= entriesEltEntryhash <> "credits" .= entriesEltCredits <>
       "version" .=
       entriesEltVersion <>
       "sig" .=
       entriesEltSig <>
...
instance FromJSON Header where
  parseJSON (Object v) =
    Header <$> v .: "prevheaderhash" <*> v .: "bodyhash" <*> v .: "bodysize" <*>
    v .: "prevfullhash" <*>
    v .: "chainid" <*>
    v .: "ecchainid" <*>
    v .: "dbheight" <*>
    v .: "headerexpansionarea" <*>
    v .: "objectcount"
  parseJSON _ = mzero
...
instance ToJSON Header where
  ...
  toEncoding (Header {..}) =
    pairs
      ("prevheaderhash" .= headerPrevheaderhash <> "bodyhash" .= headerBodyhash <>
       "bodysize" .=
       headerBodysize <>
       "prevfullhash" .=
       headerPrevfullhash <>
